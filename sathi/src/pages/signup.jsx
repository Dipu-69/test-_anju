...
import signupImg from "../assets/auth-signup.jpg"; // <- fixed import
...
export default function Signup() {
    ...
    const onSubmit = (e) => {
        ...
        setLoading(true);
        setTimeout(() => {
            const user = { name, email, token: "demo-token" };
    ...
    return (
        <div className="mx-auto grid min-h-screen max-w-6xl grid-cols-1 items-center gap-10 px-6 py-10 md:grid-cols-2">
            ...
            <div className="relative hidden md:block">
                <div className="absolute -inset-6 -z-10 rounded-3xl bg-gradient-to-tr from-accent/15 via-primary/10 to-transparent blur-2xl" />
                <img
                    src={signupImg}
            ...
            <div className="mx-auto w-full max-w-md">
                ...
                <div className="rounded-2xl border bg-background/90 p-6 shadow-sm">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">It’s quick and free.</p>
                    ...
                    <div className="mt-4 text-center text-sm text-muted-foreground">
                        ...
                        <Link className="text-primary hover:underline" to={`/login?next=${encodeURIComponent(next)}`}>
                            Sign in
                        </Link>
                    </div>
                </div>
